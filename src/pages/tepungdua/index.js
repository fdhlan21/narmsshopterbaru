...
export default function TepungDua({ navigation, route }) {
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
        <ImageBackground source={require('../../assets/bgtopheader.png')} style={{padding:10}}>
          ...
          <View style={styles.headerContainer}>
            <TouchableOpacity onPress={() => navigation.navigate('SembakoPage')} style={styles.backButton}>
        ...
        <View>
            ...
            <View style={{justifyContent:'center'}}>
                <Image source={require('../../assets/grubfilterhargarendah.png')}
                style={{
                    width:53, height:29,
...
{/* Modal untuk opsi penyortiran */}
  ...
  setModalVisible(false);
  navigation.navigate('TepungPage');
}}>
          <View style={{justifyContent:"center"}}>
